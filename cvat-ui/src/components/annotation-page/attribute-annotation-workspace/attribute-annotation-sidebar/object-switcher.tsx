...
function ObjectSwitcher(props: Props): JSX.Element {
    ...
    return (
        <div className='cvat-attribute-annotation-sidebar-object-switcher'>
            <CVATTooltip title={t('Previous object {{shortcut}}', { shortcut: normalizedKeyMap.PREVIOUS_OBJECT })}>
                <Button
            ...
            <CVATTooltip title={t('Next object {{shortcut}}', { shortcut: normalizedKeyMap.NEXT_OBJECT })}>
                <Button
