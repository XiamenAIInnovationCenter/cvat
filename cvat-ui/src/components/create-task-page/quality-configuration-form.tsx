                ...
                {supportsFrameSelection && (
                    <Col>
                        <Form.Item
                            ...
                            label={this.t('Frame selection method')}
                            rules={[{ required: true, message: this.t('Please, specify frame selection method') }]}
                        >
                            <Select
                                className='cvat-select-frame-selection-method'
                                onChange={onChangeFrameSelectionMethod}
                            >
                                <Select.Option value={FrameSelectionMethod.RANDOM}>{this.t('Random')}</Select.Option>
                                <Select.Option value={FrameSelectionMethod.RANDOM_PER_JOB}>
                                    {this.t('Random per job')}
                                </Select.Option>
                            </Select>
                        </Form.Item>
                    </Col>
                    ...
                    supportsValidationQuantity && frameSelectionMethod === FrameSelectionMethod.RANDOM && (
                        <Col span={7}>
                            <Form.Item
                                ...
                                rules={[
                                    { required: true, message: this.t('The field is required') },
                                    {
                                        type: 'number', min: 0, max: 100, message: this.t('Value is not valid'),
                                    },
                                ]}
                            >
                                <Input
